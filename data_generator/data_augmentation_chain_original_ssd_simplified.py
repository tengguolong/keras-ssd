...
from data_generator.object_detection_2d_photometric_ops import ConvertColor, ConvertDataType, ConvertTo3Channels, RandomBrightness, RandomContrast, RandomGamma
...
class SSDPhotometricDistortions:
    ...
    def __init__(self):
        ...
        self.random_brightness = RandomBrightness(lower=-16, upper=16, prob=0.5)
        self.random_contrast = RandomContrast(lower=0.75, upper=1.25, prob=0.5)
        self.random_gamma = RandomGamma(lower=0.6, upper=1.8, prob=0.5)
