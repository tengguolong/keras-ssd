...
scales=cfg.DEFAULT_BOXES_SCALES
print('\nUsed scales: ', scales, '\n')
...
model_checkpoint = ModelCheckpoint(filepath='snapshot/ssd512_UsingAug_epoch-{epoch:02d}_loss-{loss:.3f}_val_loss-{val_loss:.3f}.h5',
                                   monitor='loss',
                                   verbose=1,
...
csv_logger = CSVLogger(filename='log/ssd512_UsingAug_training_log.csv',
                       separator=',',
                       append=True)
